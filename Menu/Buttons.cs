    ...
    internal class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            new ButtonInfo[] { // Main Mods
                ...
                new ButtonInfo { buttonText = "test", method =() => TestMod.TestSpeedMod(), toolTip = "Gives a speedboost. (HEAVILY WIP)", isTogglable = true},
                new ButtonInfo { buttonText = "togglable placeholder"},
                new ButtonInfo { buttonText = "toggleble placeholder 2", isTogglable = false},
